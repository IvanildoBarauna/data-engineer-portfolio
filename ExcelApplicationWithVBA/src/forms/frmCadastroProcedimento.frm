VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmCadastroProcedimento 
   Caption         =   "Cadastro e Gerenciamento de Procedimentos"
   ClientHeight    =   7545
   ClientLeft      =   120
   ClientTop       =   460
   ClientWidth     =   6120
   OleObjectBlob   =   "frmCadastroProcedimento.frx":0000
   StartUpPosition =   1  'CenterOwner
   Tag             =   "tbCadastroProcedimento"
End
